...
from app.schemas.sim_cart import SimCartCreate, SimCartBase, SimCartUpdate
...
@sim_cart_v1.post("/sim_cart", response_model=SimCartBase, )
...
@sim_cart_v1.get("/sim_carts", response_model=list[SimCartBase])
...
@sim_cart_v1.get("/sim_cart/{sim_cart_id}", response_model=SimCartBase)
...
@sim_cart_v1.put("/sim_cart/{sim_cart_id}", response_model=SimCartBase)
...
@sim_cart_v1.delete("/sim_cart/{sim_cart_id}", response_model=SimCartBase)
